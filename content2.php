    ...
    <fieldset class="doc_fieldset">
        ...
        <table>
            <tr id="r_cat">
                ...
                <td class="doc_field">
                    <select name="categoria" id="categoria" class="full_field">
                        <?php
                        while($categoria = $res_categorie->fetch_assoc()){
                            ?>
                            <option <?php if($categoria['id_categoria'] == $current_doc['categoria'] || ($current_doc == null && $categoria['id_categoria'] == 17)) print("selected='selected'") ?> value="<?php print $categoria['id_categoria'] ?>"><?php print $categoria['nome'] ?></option>
                        <?php } ?>
                    </select>
                </td>
            </tr>
        ...
        <table>
            ...
            <tr id="t_file">
                ...
                <td class="doc_field" id="if_container">
                    ...
                    <?php }  else{ ?>
                        <div id="iframe"><iframe src="upload_manager.php?upl_type=document&area=teachers&tipo=2" id="aframe"></iframe></div>
